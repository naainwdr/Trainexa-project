    ...
    <div style={{ minHeight: "100vh", background: "#000", color: "#fff", fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
      ...
      <main style={{ padding: "120px 72px 80px", maxWidth: "1200px", margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "48px" }}>
          <div>
            <h1 style={{ fontSize: "36px", fontWeight: "800", marginBottom: "8px" }}>Cabang Olahraga</h1>
            <p style={{ color: "#aaa", fontSize: "16px" }}>Kelola keahlian Anda</p>
          </div>
          <Link href="/pelatih/olahraga/tambah">
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
          {coachSports.map((sport) => (
            <div key={sport.id} style={{ backgroundColor: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: "20px", padding: "24px 32px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
              <div style={{ display: "flex", alignItems: "center", gap: "24px" }}>
                <div style={{ width: "64px", height: "64px", backgroundColor: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: "16px", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "28px" }}>
                  {sport.icon}
                </div>
                <h3 style={{ fontSize: "24px", fontWeight: "700" }}>{sport.name}</h3>
              </div>
              <Link href={`/pelatih/olahraga/detail`}>
                <button style={{ backgroundColor: "#fcc419", color: "#1a1a1a", border: "none", padding: "10px 32px", borderRadius: "12px", fontSize: "16px", fontWeight: "800", cursor: "pointer" }}>
                  Detail
                </button>
              </Link>
            </div>
