...
export default function DetailSportPage() {
  return (
    <div style={{ minHeight: "100vh", background: "#060606", color: "#fff", fontFamily: "'Plus Jakarta Sans', sans-serif", display: "flex", flexDirection: "column" }}>
      ...
      <main style={{ flex: 1, padding: "120px 72px 80px", maxWidth: "1200px", margin: "0 auto", width: "100%" }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "40px" }}>
          <div>
            <h1 style={{ fontSize: "42px", fontWeight: "800", marginBottom: "8px", letterSpacing: "-1px" }}>Detail Cabang<br/>Olahraga Badminton</h1>
            <p style={{ color: "#aaa", fontSize: "16px" }}>Informasi olahraga cabang anda</p>
          </div>
          <div style={{ display: "flex", gap: "16px" }}>
             {/* Edit Button */}
            <Link href="/pelatih/olahraga/edit">
              <button style={{ backgroundColor: "#fcc419", color: "#1a1a1a", border: "none", padding: "12px 64px", borderRadius: "12px", fontSize: "24px", fontWeight: "900", cursor: "pointer" }}>
                Edit
              </button>
            </Link>
          </div>
        ...
        <div style={{ backgroundColor: "#111", border: "1px solid #222", borderRadius: "24px", padding: "48px" }}>
          ...
          <div style={{ marginBottom: "32px" }}>
            ...
            <div style={{ position: "relative" }}>
              <select
                disabled
                style={{ width: "100%", backgroundColor: "#1a1a1a", border: "1px solid #333", borderRadius: "14px", padding: "18px", fontSize: "16px", color: "#fff", outline: "none", appearance: "none", cursor: "not-allowed" }}
              >
          ...
          <div style={{ marginBottom: "32px" }}>
            ...
            <div
              style={{ width: "100%", backgroundColor: "#1a1a1a", border: "1px solid #333", borderRadius: "14px", padding: "18px", fontSize: "16px", color: "#fff", boxSizing: "border-box" }}
            >
              Sertifikat Pelatihan Badminton Tingkat Nasional
            </div>
          </div>
          ...
          <div style={{ marginBottom: "32px" }}>
            ...
            <div
              style={{ width: "100%", backgroundColor: "#1a1a1a", border: "1px solid #333", borderRadius: "14px", padding: "18px", fontSize: "16px", color: "#fff", minHeight: "150px", boxSizing: "border-box", lineHeight: "1.6" }}
            >
              Dokumentasi pelatihan badminton bersama client member saya
            </div>
          </div>
