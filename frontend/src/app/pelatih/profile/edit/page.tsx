...
export default function EditProfilePage() {
  ...
  const [formData, setFormData] = useState({
    namaLengkap: "Arif Santoso",
    nomorTelepon: "+62 812-3456-7890",
    city: "Jakarta Selatan",
    bio: "Pelatih bulu tangkis bersertifikat PBSI dengan 11 tahun pengalaman melatih pemain dari tingkat pemula hingga nasional",
    namaBank: "Bank BCA",
    nomorRekening: "0218392841038214",
    namaPemilikBank: "Arif Santoso",
  });
    ...
    <div style={{ minHeight: "100vh", background: "#000", color: "#fff", fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
      ...
      <main style={{ padding: "120px 72px 80px", maxWidth: "1200px", margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "40px" }}>
          <div>
            <h1 style={{ fontSize: "36px", fontWeight: "800", marginBottom: "12px" }}>Edit Profil Saya</h1>
            <p style={{ color: "#aaa", fontSize: "16px" }}>Kelola profil anda yang akan tampil ke publik</p>
          </div>
          <div style={{ display: "flex", gap: "16px" }}>
            <Link href="/pelatih/profile">
              <button style={{ backgroundColor: "#8c2e2e", color: "#fff", border: "none", padding: "12px 32px", borderRadius: "12px", fontSize: "18px", fontWeight: "800", cursor: "pointer" }}>
                Batal
              </button>
            </Link>
            <button 
              onClick={handleSave}
              style={{ backgroundColor: "#fcc419", color: "#1a1a1a", border: "none", padding: "12px 32px", borderRadius: "12px", fontSize: "18px", fontWeight: "800", cursor: "pointer" }}
            >
              Simpan
            </button>
          </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "32px" }}>
          ...
          <div style={{ backgroundColor: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: "24px", padding: "32px" }}>
            ...
            <div style={{ marginBottom: "24px" }}>
              ...
              <input
                ...
                style={{ width: "100%", backgroundColor: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: "12px", padding: "16px", fontSize: "16px", color: "#fff", outline: "none" }}
              />
            </div>
            ...
            <div style={{ marginBottom: "24px" }}>
              ...
              <div style={{ position: "relative" }}>
                <select
                  ...
                  value={formData.city}
                  onChange={handleChange}
                  style={{ width: "100%", backgroundColor: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: "12px", padding: "16px", fontSize: "16px", color: "#fff", outline: "none", appearance: "none" }}
                >
                  <option value="Jakarta Selatan">Jakarta Selatan</option>
                  <option value="Bandung">Bandung</option>
                  <option value="Surabaya">Surabaya</option>
                </select>
                <span style={{ position: "absolute", right: "16px", top: "50%", transform: "translateY(-50%)", fontSize: "12px", pointerEvents: "none" }}>▼</span>
              </div>
            </div>
            ...
            <div style={{ marginBottom: "0" }}>
              ...
              <textarea
                ...
                value={formData.bio}
                onChange={handleChange}
                style={{ width: "100%", backgroundColor: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: "12px", padding: "16px", fontSize: "16px", color: "#fff", outline: "none", minHeight: "150px", resize: "none", lineHeight: "1.6" }}
              />
            </div>
          </div>
          ...
          <div style={{ backgroundColor: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: "24px", padding: "32px" }}>
            ...
            <div style={{ marginBottom: "24px" }}>
              ...
              <input
                type="text"
                name="namaPemilikBank"
                value={formData.namaPemilikBank}
                onChange={handleChange}
                style={{ width: "100%", backgroundColor: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.1)", borderRadius: "12px", padding: "16px", fontSize: "16px", color: "#fff", outline: "none" }}
              />
            </div>
