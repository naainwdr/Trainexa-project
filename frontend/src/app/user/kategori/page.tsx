...
const coaches = [
  { id: 1, name: "Sofia", specialty: "Bulu Tangkis", location: "Cimpenan, Kota Bandung", rating: 4.96, reviewCount: 391, price: 125000, tags: ["ATP Certified", "Competitive"], badge: "Full hari ini", emoji: "🏸", bg: "linear-gradient(135deg,#1a1a2e,#16213e)" },
  { id: 2, name: "Rafael", specialty: "Bola Basket", location: "Kemang, Kota Jakarta", rating: 4.88, reviewCount: 187, price: 150000, tags: ["Pro League", "Competitive"], badge: "Tersedia", emoji: "🏀", bg: "linear-gradient(135deg,#0f3460,#533483)" },
  { id: 3, name: "Yogi", specialty: "Yoga", location: "Seminyak, Kota Bandung", rating: 4.96, reviewCount: 304, price: 95000, tags: ["Certified", "Online"], badge: "Full hari ini", emoji: "🧘", bg: "linear-gradient(135deg,#1b4332,#2d6a4f)" },
  { id: 4, name: "Dian", specialty: "Renang", location: "Gubeng, Kota Surabaya", rating: 4.72, reviewCount: 187, price: 110000, tags: ["FINA Certified"], badge: "Tersedia", emoji: "🏊", bg: "linear-gradient(135deg,#023e8a,#0096c7)" },
  { id: 5, name: "Budi", specialty: "Futsal", location: "Buah Batu, Kota Bandung", rating: 4.63, reviewCount: 220, price: 85000, tags: ["Lisensi C", "Competitive"], badge: "Full hari ini", emoji: "⚽", bg: "linear-gradient(135deg,#370617,#6a040f)" },
  { id: 6, name: "Citra", specialty: "Lari", location: "Menteng, Kota Jakarta", rating: 4.91, reviewCount: 143, price: 100000, tags: ["Marathon Pro"], badge: "Tersedia", emoji: "🏃", bg: "linear-gradient(135deg,#212529,#495057)" },
  { id: 7, name: "Andi", specialty: "Tinju", location: "Bandung", rating: 4.78, reviewCount: 98, price: 120000, tags: ["Boxing Licensed"], badge: "Tersedia", emoji: "🥊", bg: "linear-gradient(135deg,#3d0000,#800000)" },
  { id: 8, name: "Maya", specialty: "Tennis", location: "Jakarta Selatan", rating: 4.85, reviewCount: 211, price: 135000, tags: ["WTA Certified"], badge: "Full hari ini", emoji: "🎾", bg: "linear-gradient(135deg,#1a472a,#2d6a4f)" },
];
