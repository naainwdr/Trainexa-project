...
export default function UserPelatihPage() {
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "20px" }}>
            {coaches.map(coach => (
              <Link key={coach.id} href={`/pelatih/${coach.id}`} style={{ textDecoration: "none" }}>
                <div
                  style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: "16px", overflow: "hidden", transition: "all 0.25s", cursor: "pointer" }}
